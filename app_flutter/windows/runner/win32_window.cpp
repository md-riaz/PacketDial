...
///
/// Redefined here because the value didn't move into stable headers until
/// Windows SDK 20348, but it's available since Chrome 74 which supports
/// Windows 10 1709+. See
...
LRESULT CALLBACK Win32Window::WndProc(HWND const window, UINT const message,
  ...
  if (message == WM_NCCREATE) {
    ...
    EnableNonClientDpiScalingProc* enableNonClientDpiScaling = nullptr;
    if (HMODULE user32_module = LoadLibraryA("User32.dll")) {
